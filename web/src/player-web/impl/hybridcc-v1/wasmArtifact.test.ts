...
const EXPECTED_SOURCE_COMMIT = "93b599bdf76f86826aa0a6b3d851383353fa83d8";
const EXPECTED_JS_SHA256 = "c70eb34985d4eda9f49a5d2ae6487e7d33006be5cba81f5d14084771124bb02a";
const EXPECTED_WASM_SHA256 = "20d448caf3091cc131dd517d16ef3f80e2a09625a716b251bf85fe91f4b31046";
...
describe("pinned HybridCC v1 WebAssembly artifact", () => {
  it("matches the reviewed PR42 provenance and byte hashes", async () => {
    ...
    expect(manifest).toMatchObject({
      ...
      sourceMergeCommit: "aba5f398ac281414978dfb77c86a83e6f3b82237",
      sourcePullRequest: "https://github.com/joshua-bone/HybridCC2026/pull/42",
      artifacts: {
