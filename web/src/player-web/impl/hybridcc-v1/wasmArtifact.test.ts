...
const EXPECTED_SOURCE_COMMIT = "71bf3451351bab58c3386d5f4451f891468fcf07";
const EXPECTED_JS_SHA256 = "c70eb34985d4eda9f49a5d2ae6487e7d33006be5cba81f5d14084771124bb02a";
const EXPECTED_WASM_SHA256 = "bec20e427bd454a7f9bb15fec752de587bc6d6e4f2857b5cafb4de78a6d54f28";
...
describe("pinned HybridCC v1 WebAssembly artifact", () => {
  it("matches the reviewed ruleset 1.0.9 engine", async () => {
    ...
    expect(manifest).toMatchObject({
      ...
      sourceMergeCommit: "f4f2950f8125a60c0ba2e8e28851f945aca708aa",
      sourcePullRequest: "https://github.com/joshua-bone/HybridCC2026/pull/55",
      artifacts: {
