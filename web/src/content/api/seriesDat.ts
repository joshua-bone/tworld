...
import { decodeLatin1, readUint16, trimNulls } from "@content/api/contentBinary";
...
function groupContiguousThreeDLevelRuns<T extends { name: string }>(entries: readonly T[]): ThreeDLevelRun[] {
